...
//#define debugUART			&huart2		// Opcjonalny UART na potrzeby debugowania (odkomentuj DEBUG_RX)
...
extern _Bool data_available;					// Jest używane zarówno w main.c jak i hoverserial.c
